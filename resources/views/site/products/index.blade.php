            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12 col-lg-3">
                        ...
                        <form class="filter">
                            ...
                            <div class="collapse-container">
                                            ...
                                            @foreach($categories as $item)
                                                ...
                                                <h5 class="category-title">
                                                    <a href="{{ URL::to($lang.'/single/category/'.$item->slug) }}">
                                                        {{ $item->name.' ('.$sub_item->product_count.')' }}
                                                    </a>
                                                </h5>
                                                @endif
                                            @endforeach
                                ...
                                <div class="custom-collapse main">
                                    ...
                                    <div class="collapse-body show">
                                        <div class="price-range">
                                            <input name="low_price" type="number" value="{{ $dep->low_price }}" placeholder="{{ $dep->low_price }}" class="filter_action">
                                            {{ trans('home.To') }}
                                            <input name="up_price" type="number" value="{{ $dep->up_price }}" placeholder="{{ $dep->up_price }}" class="filter_action">
                                        </div>
                                    </div>
                                </div>
                                ...
                                @endif
                                <input type="hidden" id="department_id" value="{{ $dep->id }}">
                    ...
                    <div class="col-12 col-lg-9">
                        ...
                        @foreach($categories->where('product_count','>',0)->take(9) as $item)
                            <li>
