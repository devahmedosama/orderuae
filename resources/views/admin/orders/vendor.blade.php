...
<div class="row">
    <div class="col-12">
        <div class="card">
                <div class="card-body">
                    {{ Form::open(['url'=>'admin/vendor/orders/'.$vendor->id,'method'=>'GET']) }}
                    <div class="row">
                            ...
                            <div class="col-md-4 form-group">
                                {{ Form::select('store_id',$stores,app('request')->input('store_id'),['class'=>'form-control basic-select','placeholder'=>'order store']) }}
                            </div>
                   ...
                   <!--  </br> -->
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th scope="row">Order_{{ $data->id  }}</th>
                                <td>
                                ...
                                <td>
                                    ...
                                    @if($data->state < 2)
                                    <a href="{{ URL::to('admin/orders/view/'.$data->id) }}" class="btn btn-md btn-success">Delivered</a>
                                    @endif
