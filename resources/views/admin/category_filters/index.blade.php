    ...
    <div class="col-12">
        ...
        <nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
            <ol class="breadcrumb pt-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">{{ $category->name }} Filters</li>
            </ol>
        </nav>
...
<div class="row">
    <div class="text-right col-md-12">
            <a href="{{ URL::to('admin/category/filters/add/'.$category->id)  }}" class="btn btn-primary pull-right add_btn">Add New </a>
    </div>
    <div class="col-12">
        <div class="card">
                <div class="card-body">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ URL::to('admin/category/filters/edit/'.$data->id) }}" class="btn btn-md btn-primary">Edit</a>
                                      ...
                                      <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                          ...
                                          <div class="modal-footer">
                                            ...
                                            <a href="{{ URL::to('admin/category/filters/delete/'.$data->id) }}" class="btn btn-danger">{{ trans('home.Confirm') }}</a>
                                          </div>
                                        </div>
                                      </div>
                                    </div>
