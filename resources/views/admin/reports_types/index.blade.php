                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $data->name }}</td>
                                <td>
                                    <a href="{{ URL::to('admin/reports/types/edit/'.$data->id) }}" class="btn btn-md btn-primary">Edit</a>
                                      ...
                                      <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                          ...
                                          <div class="modal-footer">
                                            ...
                                            <a href="{{ URL::to('admin/reports/types/delete/'.$data->id) }}" class="btn btn-danger">{{ trans('home.Confirm') }} </a>
                                          </div>
                                        </div>
                                      </div>
                                    </div>
