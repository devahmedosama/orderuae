...
<div class="row">
    <div class="col-12">
        <div class="card">
                <div class="card-body">
                    <img src="http://localhost/order/uploads/ads/1631799174.png" class="ads_img">
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <th scope="row"><img src="{{ URL::to($data->image) }}" width="200" class="img-responsive"></th>
                                <td>{{ ($data->store)?$data->store->name:' ' }}</td>
                                <td> {{ ($data->product)?$data->product->name:' ' }} </td>
                                <td> {{ ($data->department)?$data->department->name:' ' }} - {{ ($data->category)?$data->category->name:' ' }} </td>
                                <td>
                                    <a href="{{ URL::to('admin/ads/edit/'.$data->id) }}" class="btn btn-md btn-primary">Edit</a>
                                      ...
                                      <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                          ...
                                          <div class="modal-footer">
                                            ...
                                            <a href="{{ URL::to('admin/ads/delete/'.$data->id) }}" class="btn btn-danger">{{ trans('home.Confirm') }}</a>
                                          </div>
                                        </div>
                                      </div>
                                    </div>
