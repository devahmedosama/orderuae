...
<div class="row">
    <div class="col-12">
        <div class="card">
                <div class="card-body">
                    {{ Form::open(['url'=>'admin/store/reviews','method'=>'GET']) }}
                    <div class="row">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ URL::to('admin/stores/edit/'.$data->store_id) }}" class="btn btn-xs btn-primary" target="_blank">
                                        {{ $data->store->name }}
                                    </a>
                                </td>
                                <td> 
                                      ...
                                      <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                          ...
                                          <div class="modal-footer">
                                            ...
                                            <a href="{{ URL::to('admin/store/reviews/delete/'.$data->id) }}" class="btn btn-danger">{{ trans('home.Confirm') }}</a>
                                          </div>
                                        </div>
                                      </div>
                                    </div>
