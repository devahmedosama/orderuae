    ...
    <div class="col-12">
        <div class="card">
                <div class="card-body">
                    ...
                    {{ Form::open(['url'=>'admin/payments/processes','method'=>'GET']) }}
                    <div class="row">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th scope="row">{{ $data->payment_no  }}</th>
                                <td>{{ $data->amount }} .Dhs</td>
                                <td> 
                                    <a href="{{ URL::to('admin/users/single/'.$data->user_id.'?state=2') }}" class="btn btn-xs btn-primary">
                                        {{ $data->user->first_name  }} {{ $data->user->last_name  }}
                                    </a> 
                                </td>
                                <td>
                                    <a href="{{ URL::to('admin/orders/view/'.$data->order_id) }}" class="btn btn-xs btn-success">
