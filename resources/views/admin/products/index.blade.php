                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ URL::to('admin/products/filters/'.$data->id) }}" class="btn btn-md btn-success">Product Filter</a>
                                    <a href="{{ URL::to('admin/products/edit/'.$data->id) }}" class="btn btn-md btn-primary">Edit</a>
