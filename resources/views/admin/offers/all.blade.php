    ...
    <div class="col-12">
        ...
        <nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
            <ol class="breadcrumb pt-0">
                ...
                <li class="breadcrumb-item">
                    <a href="{{ URL::to('admin/products/'.$store->id) }}">Store Product</a>
                </li>
                                    ...
                                    <div class="modal fade" id="exampleModal_offer_{{ $data->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                      <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                          ...
                                          {{ Form::open(['url'=>'admin/edit/product/offer/'.$data->id,'class'=>'ajax_form edit_form']) }}
                                          ...
                                          <div class="modal-body">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <div class="custom-file">
                                                   {{ Form::number('minimum_order',$data->minimum_order,['class'=>'form-control','required','min'=>0]) }}
                                                </div>
                                            </div>
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                                ...
                                                <div class="custom-file">
                                                   {{ Form::date('start_day',$data->start_day,['class'=>'form-control','required']) }}
                                                </div>
                                            </div>
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                      ...
                                      <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                          ...
                                          <div class="modal-footer">
                                            ...
                                            <a href="{{ URL::to('admin/offers/delete/'.$data->id) }}" class="btn btn-danger">{{ trans('home.Confirm') }} </a>
                                          </div>
                                        </div>
                                      </div>
                                    </div>
