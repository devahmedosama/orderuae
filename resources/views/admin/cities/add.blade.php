...
<div class="row">
    <div class="col-12">
        <div class="card mb-4">
            <div class="card-body">
                {{ Form::open(['url'=>'admin/cities/add','files'=>true,'enctype'=>'multipart']) }}
                    ...
                    <div class="input-group mb-3">
                        ...
                        <div class="custom-file">
                           {{ Form::select('country_id',$items,(old('country_id'))?old('country_id'):app('request')->input('country_id'),['class'=>'form-control']) }}
                        </div>
                    </div>
