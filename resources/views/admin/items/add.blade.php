    ...
    <div class="col-12">
        ...
        <nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
            <ol class="breadcrumb pt-0">
                ...
                <li class="breadcrumb-item">
                    <a href="{{ URL::to('admin/products/'.$id) }}">Products</a>
                </li>
...
<div class="row">
    <div class="col-12">
        <div class="card mb-4">
            <div class="card-body">
                {{ Form::open(['url'=>'admin/restaurant/items/add/'.$id,'files'=>true,'enctype'=>'multipart']) }}
                    <div class="row">
                        <div class="col-md-6">
                            <div class="input-group mb-3">
                                ...
                                <div class="custom-file">
                                   {{ Form::number('price',old('price'),['class'=>'form-control','required','min'=>0,'step'=>'any']) }}
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
