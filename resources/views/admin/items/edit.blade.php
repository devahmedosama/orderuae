...
<div class="row">
    <div class="col-12">
        <div class="card mb-4">
            <div class="card-body">
                 {{ Form::open(['url'=>'admin/restaurant/items/edit/'.$data->id,'files'=>true,'enctype'=>'multipart']) }}
                    <div class="row">
                        <div class="col-md-6">
                            <div class="input-group mb-3">
                                ...
                                <div class="custom-file">
                                   {{ Form::number('price',$data->price,['class'=>'form-control','required','min'=>0,'step'=>'any']) }}
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="row color_item">
                            ...
                            <div class="col-md-4">
                              <div class="input-group mb-3">
                                ...
                                <div class="custom-file">
                                    <input  type="number" value="{{ $size->price }}" required="" min="0" class="form-control" step="any" name="old_size_price[]">
                                </div>
                              </div>
                            </div>
                        </div>
                        ...
                        <div class="row color_item">
                           ...
                           <div class="col-md-4">
                              <div class="input-group mb-3">
                                 ...
                                 <div class="custom-file">
                                    <div class="custom-file">                
                                        <input type="number" step="any" value="{{ $upon->price }}" class="form-control" required="" name="old_upon_price[]">              
                                    </div>
                                 </div>
                              </div>
                           </div>
...
<script src="{{ URL::to('assets/admin') }}/js/vendor/ckeditor5-build-classic/ckeditor.js"></script>
<script type="text/javascript">
