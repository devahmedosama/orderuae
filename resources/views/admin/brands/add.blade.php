...
<div class="row">
    <div class="col-12">
        <div class="card mb-4">
            <div class="card-body">
                {{ Form::open(['url'=>'admin/brands/add','files'=>true,'enctype'=>'multipart']) }}
                    ...
                    <div class="input-group mb-3">
                        ...
                        <div class="custom-file">
                           {{ Form::select('category_id',App\Models\Category::all_cats(),null,['class'=>'js-example-basic-single form-control']) }}
                        </div>
                    </div>
