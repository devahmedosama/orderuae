...
<div class="row">
    <div class="col-12">
        <div class="card mb-4">
            <div class="card-body">
                 {{ Form::open(['url'=>'vendors/dashboard/products/edit/'.$data->id,'files'=>true,'enctype'=>'multipart']) }}
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="input-group mb-3">
                                ...
                                <div class="custom-file">
                                   {{ Form::select('brand_id',$brands,$data->brand_id,['class'=>'form-control js-example-basic-single','required','min'=>0,'placeholder'=>'Choose Brand ']) }}
                                </div>
                            </div>
                        </div>
                        @endif
                    ...
                    @if($store->department_id  == 2  || $store->department_id == 1)
                        <div class="input-group mb-3">
                            ...
                            <div class="custom-file">
                               {{ Form::file('color_images[]',['class'=>'form-control','required']) }}
                            </div>
                        </div>
                        @if(count($data->metas))
                        <div class="input-group mb-3">
                            <ul class="imgs_ul">
                                @foreach($data->metas[0]->image as $key=>$img)
                                   <li>
