                ...
                <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-7 text-right">
                          ...
                          <a href="{{ URL::to('vendors/dashboard/restaurant/items/add/'.$id) }}" class="btn btn-md btn-primary add_btn">Add New Item</a>
                           <a href="{{ URL::to('vendors/dashboard/restaurant/menu/'.$id) }}" class="btn btn-md btn-primary add_btn">Menu Items</a>
                      </div>
                    </div>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ URL::to('vendors/dashboard/restaurant/items/edit/'.$data->id) }}" class="btn btn-md btn-primary">Edit</a>
